...
export const dataStaff = [
    ...
    
    {
        ...
        name: "Tracey Johnson",
        position: "Coach",
        description: "Tracey has been playing competitive tennis for 7 years in Australia and the UK and coaching for 2 years. Tracey has been extensively mentored by key gurus within the tennis industry. She is a true student of the sport with an immense passion for tennis coaching and coach education. Following a successful career in policing and international relations.",
    ...
    
    {
        ...
        name: "James Cornwell",
        position: "Coach",
        description: "James is a distinguished graduate of Match Point Tennis Academy. Coming from a background in endurance sports, he has focused more on tennis over the last 5 years. A student of the game, James shares his enthusiasm for all aspects of tennis; strokes, movement, tactics, in order to help you achieve your tennis goals.",
    ...
    
    {
        ...
        name: "Troy Portman",
        position: "Coach",
        description: "Troy has been coaching with Match Point since 2007. He grew up in country NSW and has been involved with tennis his whole life. He is fortunate to be able to play around the globe throughout the year and has coached regularly for many years in both Singapore and Australia.",
